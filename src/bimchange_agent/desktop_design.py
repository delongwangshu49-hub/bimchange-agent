...
def stylesheet(theme: str) -> str:
    ...
    return f"""
QWidget {{ background: {palette['canvas']}; color: {palette['text']}; font-family: \"Segoe UI\", \"Microsoft YaHei UI\"; font-size: 14px; }}
...
QTabBar::tab {{ background: transparent; color: {palette['muted']}; padding: 10px 18px; border-bottom: 2px solid transparent; }}
...
QSplitter::handle {{ background: {palette['border']}; width: 4px; height: 4px; margin: 3px; border-radius: 2px; }}
