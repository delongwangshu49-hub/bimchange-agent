...
TEXT: dict[str, dict[str, str]] = {
    "zh_CN": {
        ...
        "preview_note": "有界 IFC4 · 确定性结果优先 · AI 默认关闭",
        ...
        "metric_geometry": "几何变化",
        "metric_relationship": "关系变化",
        ...
        "change_geometry_modified": "几何修改",
        "change_relationship_modified": "关系修改",
        "change_unsupported": "未支持",
        "geometry_placement_translation": "放置平移",
        "geometry_extrusion_dimension_change": "拉伸参数尺寸变化",
        "geometry_tessellated_vertex_geometry_change": "网格顶点形状变化",
        "relationship_spatial_containment_change": "空间包含变化",
        "relationship_aggregation_change": "聚合/分解变化",
        "relationship_type_assignment_change": "类型关系变化",
        "relationship_material_assignment_change": "材料关系变化",
        ...
        "detail_geometry_subtype": "几何语义",
        "detail_delta": "位移向量",
        "detail_distance": "位移距离",
        "detail_unit": "长度单位",
        "detail_relationship_subtype": "关系语义",
        "ai_output_title": "AI 解读",
        "spatial_context_title": "局部三维",
    ...
    "en": {
        ...
        "preview_note": "Bounded IFC4 · deterministic results first · AI off by default",
        ...
        "metric_geometry": "Geometry changes",
        "metric_relationship": "Relationship changes",
        ...
        "change_geometry_modified": "Geometry modified",
        "change_relationship_modified": "Relationship modified",
        "change_unsupported": "Unsupported",
        "geometry_placement_translation": "Placement translation",
        "geometry_extrusion_dimension_change": "Extrusion dimension change",
        "geometry_tessellated_vertex_geometry_change": "Tessellated vertex shape change",
        "relationship_spatial_containment_change": "Spatial containment change",
        "relationship_aggregation_change": "Aggregation/decomposition change",
        "relationship_type_assignment_change": "Type assignment change",
        "relationship_material_assignment_change": "Material assignment change",
        ...
        "detail_geometry_subtype": "Geometry semantic",
        "detail_delta": "Displacement vector",
        "detail_distance": "Displacement distance",
        "detail_unit": "Length unit",
        "detail_relationship_subtype": "Relationship semantic",
        "ai_output_title": "AI explanation",
        "spatial_context_title": "Local 3D",
...
#summaryCard[metricKind="geometry_modified"] {{ border-top-color: {palette['warning']}; }}
#summaryCard[metricKind="relationship_modified"] {{ border-top-color: {palette['success']}; }}
